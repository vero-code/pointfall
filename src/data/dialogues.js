...
export const DIALOGUES = { 
  crashed: {
    ...
    lexa: {
      ...
      text_lvl1_audio: "/audio/lexa_text_lvl1.mp3",
      clue_choice1: "[1] I see.",
      // Lvl 2 Water
      water_prompt: "I don't feel good... my head is spinning… is my astronaut okay?...",
      water_prompt_audio: "/audio/lexa_water_prompt.mp3",
      water_choice1: "[1] Give water.",
      water_choice2: "[2] Save it for another.",
      // Lvl 3 Lollipop
      lollipop_prompt: "...",
      ...
      door_prompt_audio: "/audio/lexa_door_prompt.mp3",
      door_choice1: "[1] Ask to open the door.",
      door_choice2: "[2] Keep silent.",
      // Lvl 5 Carry
      carry_prompt: "It's getting closer, let's get out of this horrible place...",
      carry_prompt_audio: "/audio/lexa_carry_prompt.mp3",
      carry_choice1: "[1] Ask for help with MAYA.",
      carry_choice2: "[2] (Nevermind)",
      // Default
      text: "My astronaut..."
    ...
    martha: {
      ...
      text_lvl1_audio: "/audio/martha_text_lvl1.mp3",
      clue_choice1: "[1] I see.",
      // Lvl 2 Water
      water_prompt: "Don't waste it on me... save her... I beg you, give it to the child…",
      water_prompt_audio: "/audio/martha_water_prompt.mp3",
      water_choice1: "[1] Give water.",
      water_choice2: "[2] Save it for another.",
      // Lvl 3 Lollipop
      lollipop_prompt: "...",
      ...
      door_prompt_audio: "/audio/martha_door_prompt.mp3",
      door_choice1: "[1] Ask to open the door.",
      door_choice2: "[2] Keep silent.",
      // Lvl 5 Carry
      carry_prompt: "This is our chance to get out... But what about Maya, we need to help her!",
      carry_prompt_audio: "/audio/martha_carry_prompt.mp3",
      carry_choice1: "[1] Ask for help with MAYA.",
      carry_choice2: "[2] (Nevermind)",
      // Default
      text: "Save the child..."
